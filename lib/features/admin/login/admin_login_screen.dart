...
class _AdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: isDark ? ITMColors.darkAppBar : Colors.white,
        elevation: 1,
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: isDark ? [ITMColors.darkBackground, ITMColors.darkBackground] : [Colors.teal.shade50, Colors.white],
                    ...
                    children: [
                      ...
                      Container(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    fillColor: isDark ? ITMColors.darkSurface : Colors.grey.shade50,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border(
                              top: BorderSide(color: isDark ? ITMColors.darkDivider : Colors.grey.shade200),
                            ),
                          ),
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 11,
                                color: isDark ? ITMColors.darkTextTertiary : Colors.grey.shade600,
                              ),
                            ),
                          ),
                        ),
