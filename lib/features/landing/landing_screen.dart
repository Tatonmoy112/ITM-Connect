          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: isDark
                  ...
                  : [
                      Color.lerp(ITMColors.gradientEnd, ITMColors.gradientStart,
                          _bgController.value)!,
    ...
    return ScaleTransition(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: ITMColors.gradientEnd.withOpacity(0.45),
              blurRadius: 20,
              spreadRadius: 4,
            ),
          ],
          ...
          child: BackdropFilter(
            ...
            child: ConstrainedBox(
              ...
              child: Container(
                ...
                padding:
                    const EdgeInsets.symmetric(vertical: 38, horizontal: 28),
                decoration: BoxDecoration(
                  color: isDark
                  ...
                  children: [
                    ...
                    FadeTransition(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.verified,
                              color: ITMColors.gradientEnd, size: 20),
      ...
      child: ScaleTransition(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            splashColor: ITMColors.gradientEnd.withOpacity(0.3),
            onTap: () async {
              if (!mounted) return;
