...
class _NoticeBoardScreenState extends State<NoticeBoardScreen> {
                ...
                child: Column(
                  children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.campaign, color: Colors.white, size: iconSize + 6),
                          ),
                    ...
                    TabBar(
                      ...
                      tabs: const [
                        Tab(text: "Notices", icon: Icon(Icons.notifications_none)),
                        Tab(text: "Exam Routine", icon: Icon(Icons.event_note)),
                      ],
                    ),
                  ],
                ),
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildNoticeCard(notices[index]).animate().fadeIn(delay: (50 * index).ms).slideY(begin: 0.1);
          },
        );
      },
    );
  ...
  Widget _buildExamRoutineTab() {
    return StreamBuilder<List<ExamRoutine>>(
      ...
      builder: (context, snapshot) {
        ...
        final uniqueBatches = allRoutines.map((e) => e.batch).toSet().toList()..sort();
        final dropdownBatches = ['All', ...uniqueBatches];

        // Filter for display
        var displayRoutines = allRoutines;
        if (_selectedBatch != 'All') {
          displayRoutines = displayRoutines.where((r) => r.batch == _selectedBatch).toList();
        }
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          value: dropdownBatches.contains(_selectedBatch) ? _selectedBatch : 'All',
                          isExpanded: true,
                  ...
                  if (_selectedBatch != 'All' && displayRoutines.isNotEmpty)
                    Material(
                      ...
                      child: InkWell(
                        onTap: () => _generateAndOpenPdf(displayRoutines, _selectedBatch),
                        borderRadius: BorderRadius.circular(8),
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
            ...
            if (displayRoutines.isEmpty)
                 ...
                 child: Center(
                   child: Column(
                     ...
                     children: [
                       ...
                       Text(
                         _selectedBatch == 'All' 
                             ? (allRoutines.isEmpty ? 'No exam schedules posted.' : 'No exams found.')
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildExamRoutineCard(displayRoutines[index]).animate().fadeIn(delay: (50 * index).ms).slideX(begin: 0.1);
                  },
                ),
              ),
          ],
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text('View Attachment', style: TextStyle(color: Colors.blue.shade800, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                  ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: _infoItem(Icons.location_on, 'Room ${routine.room}'),
                        ),
                      ],
                    ),
                  ],
  ...
  Future<void> _generateAndOpenPdf(List<ExamRoutine> routines, String batch) async {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          final tableData = routines.map((r) => [
            r.date,
            r.time, 
            '${r.courseName}\n(${r.courseCode})',
            r.examTitle,
